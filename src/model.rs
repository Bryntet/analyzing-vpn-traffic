...
impl<B: Backend> RegressionModel<B> {
    ...
    pub fn forward_step(&self, item: NetworkTrafficBatch<B>) -> RegressionOutput<B> {
...
impl<B: AutodiffBackend> TrainStep<NetworkTrafficBatch<B>, RegressionOutput<B>> for RegressionModel<B> {
    fn step(&self, item: NetworkTrafficBatch<B>) -> TrainOutput<RegressionOutput<B>> {
...
impl<B: Backend> ValidStep<NetworkTrafficBatch<B>, RegressionOutput<B>> for RegressionModel<B> {
    fn step(&self, item: NetworkTrafficBatch<B>) -> RegressionOutput<B> {
